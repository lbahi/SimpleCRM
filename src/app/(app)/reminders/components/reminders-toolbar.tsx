...
export function RemindersToolbar({ activeTab, onTabChange, search, onSearchChange }: RemindersToolbarProps) {
  return (
    <div className="flex items-center justify-between gap-4">
      <h1 className="text-lg font-semibold text-neutral-900 shrink-0">Reminders</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-8 w-[200px] rounded-md border border-neutral-200 bg-white pl-8 pr-3 text-[13px] outline-none focus:border-neutral-300"
          />
        </div>
      </div>
    </div>
