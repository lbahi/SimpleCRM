// SimpleCRM — filter-source-section.tsx
"use client";
...
interface FilterSourceSectionProps {
  selected: string[];
  onChange: (values: string[]) => void;
}

export function FilterSourceSection({ selected, onChange }: FilterSourceSectionProps) {
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => onChange(SOURCE_OPTIONS.map(o => o.value))} className="text-[11px] font-semibold text-primary hover:underline">Select all</button>
