...
async function main() {
  ...
  // ── Create Integration Agent: Facebook Messenger ────
  console.log("🤖 Upserting facebook-messenger-primary integration agent...");
  ...
  console.log("✅ facebook-messenger-primary integration agent upserted");
